...
describe("ERC404", function () {
  ...
  async function deployMinimalERC404WithERC20sAndERC721sMinted() {
    ...
    let sizes = 100000000000000000n
    let classificationSizes = [sizes, sizes*2n, sizes*4n, sizes*8n]
    await f.contract.connect(f.signers[0])._setClassificationSize(classificationSizes);
    return f
  }
